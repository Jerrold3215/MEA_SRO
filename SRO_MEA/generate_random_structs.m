...
OP_FCC(Q,1)=OP_aa_FNN_FCC;
OP_FCC(Q,2)=OP_bb_FNN_FCC;
OP_FCC(Q,3)=OP_cc_FNN_FCC;
OP_FCC(Q,4)=OP_ab_FNN_FCC;
OP_FCC(Q,5)=OP_bc_FNN_FCC;
OP_FCC(Q,6)=OP_ac_FNN_FCC;
OP_FCC(Q,7)=OP_aa_SNN_FCC;
OP_FCC(Q,8)=OP_bb_SNN_FCC;
OP_FCC(Q,9)=OP_cc_SNN_FCC;
OP_FCC(Q,10)=OP_ab_SNN_FCC;
OP_FCC(Q,11)=OP_bc_SNN_FCC;
OP_FCC(Q,12)=OP_ac_SNN_FCC;
OP_FCC(Q,13)=OP_aa_TNN_FCC;
OP_FCC(Q,14)=OP_bb_TNN_FCC;
OP_FCC(Q,15)=OP_cc_TNN_FCC;
OP_FCC(Q,16)=OP_ab_TNN_FCC;
OP_FCC(Q,17)=OP_bc_TNN_FCC;
OP_FCC(Q,18)=OP_ac_TNN_FCC;
OP_ISF(Q,1)=OP_aa_FNN_ISF;
OP_ISF(Q,2)=OP_bb_FNN_ISF;
OP_ISF(Q,3)=OP_cc_FNN_ISF;
OP_ISF(Q,4)=OP_ab_FNN_ISF;
OP_ISF(Q,5)=OP_bc_FNN_ISF;
OP_ISF(Q,6)=OP_ac_FNN_ISF;
OP_ISF(Q,7)=OP_aa_SNN_ISF;
OP_ISF(Q,8)=OP_bb_SNN_ISF;
OP_ISF(Q,9)=OP_cc_SNN_ISF;
OP_ISF(Q,10)=OP_ab_SNN_ISF;
OP_ISF(Q,11)=OP_bc_SNN_ISF;
OP_ISF(Q,12)=OP_ac_SNN_ISF;
OP_ISF(Q,13)=OP_aa_TNN_ISF;
OP_ISF(Q,14)=OP_bb_TNN_ISF;
OP_ISF(Q,15)=OP_cc_TNN_ISF;
OP_ISF(Q,16)=OP_ab_TNN_ISF;
OP_ISF(Q,17)=OP_bc_TNN_ISF;
OP_ISF(Q,18)=OP_ac_TNN_ISF;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
